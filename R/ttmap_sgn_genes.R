...
junk_low <- list(x=0)
for(i in 1: length(ttmap_part2_gtlmap$low_map)){
...
for(i in 1: length(ttmap_part2_gtlmap$mid1_map)){
...
for(i in 1: length(ttmap_part2_gtlmap$mid2_map)){
...
col.names=NA)}
for(i in 1: length(ttmap_part2_gtlmap$high_map)){
...
for(i in 1: length(ttmap_part2_gtlmap$all)){
