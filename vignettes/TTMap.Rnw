...
use the NKI breast cancer data set. 
\begin{scriptsize}
<<loadLibAndData>>=
library(breastCancerNKI)
data(nki)
experiment <- TTMap::make_matrices(nki,seq_len(10),seq_len(10)+40,
...
Pw=1.1
Bw=0
TTMAP_part1prime <-TTMap::ControlAdjustment(normal.pcl = experiment$CTRL,
...
\begin{scriptsize}
<<part2>>=
TTMAP_part1_hda <- TTMap::HyperrectangleDeviationAssessment(x = 
