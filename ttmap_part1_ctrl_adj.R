...
norm.tum.list <- meshRows.norm.hda(df1 = normal.pcl, 
df2 = tumor.pcl);
...
write_pcl(Normal.pcl,paste(org.directory,normalname,
".normMesh",sep = ""));
write_pcl(Disease.pcl,paste(org.directory,dataname,
".normMesh",sep = ""));
}
...
write.table(u,file=paste(paste(paste(org.directory,
dataname,sep="/"),
paste("batch",i-1,sep=""),sep=""),
